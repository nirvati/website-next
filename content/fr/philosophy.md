...
## Our Selection of Kubernetes and n5i

**Foundations of Innovation and Scalability**

Our commitment to user freedom is reflected in our choice of Kubernetes and n5i as the foundation of the core ecosystem of Nirvati OS.
...
Kubernetes plays a vital role as the orchestrator of our ecosystem. It enables us to provide scalable and flexible solutions that cater to diverse user needs. Just as Free “Libre” Software is about granting users the freedom to make choices, Kubernetes empowers us to offer an array of solutions, all built on the foundation of open and scalable technology that is ubiquitous in the industry.
...
n5i embodies innovation and progress. As a cutting-edge, community-driven server management solution, it symbolizes freedom and technological advancement. Built on Kubernetes and committed to open-source principles, n5i ensures users have access to the latest features while maintaining the values of “Libre.”
...
Nirvati goes beyond operating systems; our suite of tools and services simplifies digital life, enhances productivity, and supports individuals and organizations. These resources are designed to align with the Freedom concept, giving users the freedom to select the solutions that best serve their needs.
